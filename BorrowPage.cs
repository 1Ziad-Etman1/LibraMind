                ...
                if (con.State == System.Data.ConnectionState.Open)
                {
                    ...
                    if (reader.HasRows)
                    {
                        ...
                        if(Avaliablee == true)
                        {
                            ...
                            con.Open();
                            string query2 = "INSERT INTO BORROWING (BORROW_ID, U__ID, ISBN__B) VALUES (77, @Param2, @Param3)";
                            ...
                            con.Open();
                            string query3 = "INSERT INTO BORROW (USER_ID, BORROW_ID, BORROW_DATE, RETURN_DATE) VALUES (@Param4, 77, '2023-05-25 18:00:00.000', '2023-05-25 18:00:00.000')";
